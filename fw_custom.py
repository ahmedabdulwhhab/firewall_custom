...
class FirewallController(ControllerBase):
    ...
    def packet_in_handler(msg):
        ...
        if(msg.datapath.id <FW_Switches_Range):        #Ahmed notes:  define any switch has id lower than 20 don't execute it as firewall
            return
...
#ahmed notes
#disable firewall line          # FW_Switches_Range define any switch has id lower than 20 don't consider it as firewall
#regist_ofs        Line 390
